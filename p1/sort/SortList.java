...
public interface SortList<E> extends Iterable<@Nullable E> {
    ...
    /**
     * Returns an array containing all elements in this {@link SortList} in proper sequence, including gaps (null) elements.
     * @return an array of all elements in this {@link SortList}.
     */
    E[] toArray();
